...
- **Mutations:** For `POST`/`PUT` requests, do not auto-retry unless you have implemented strong Idempotency Keys (see [the API conventions](constitution/technologies/spring-boot-api.md)), to prevent double-charging or duplicate entries.
